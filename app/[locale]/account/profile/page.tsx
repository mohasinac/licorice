...
export default function ProfilePage() {
  ...
  return (
    <div className="mx-auto max-w-lg px-4 py-10">
      <h1 className="font-heading text-foreground mb-6 text-3xl font-bold">{t("myProfile")}</h1>
      ...
      <form onSubmit={handleSave} className="bg-surface space-y-4 rounded-2xl p-6 shadow-sm">
        ...
        <div>
          <label className="text-foreground mb-1 block text-sm font-medium">{t("displayName")}</label>
          <Input
            value={displayName}
      ...
      <div className="mt-10 rounded-2xl border border-red-200 bg-red-50 dark:border-red-900/50 dark:bg-red-950/30 p-6">
        <h2 className="mb-1 text-base font-semibold text-red-700 dark:text-red-400">{t("deleteAccount")}</h2>
