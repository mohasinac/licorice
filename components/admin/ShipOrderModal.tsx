      ...
      {tab === "shiprocket" && (
        <div className="space-y-4">
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <Button variant="primary" size="sm" onClick={handleShiprocket} disabled={loading}>
              {loading ? (
                <>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="border-border bg-background text-foreground placeholder:text-muted-foreground focus:ring-primary/50 w-full rounded-lg border px-3 py-2 text-sm focus:ring-2 focus:outline-none"
            />
          </div>
          <div>
            <label className="text-foreground mb-1 block text-sm font-medium">
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <Button variant="primary" size="sm" onClick={handleManual} disabled={loading}>
              {loading ? (
                <>
                  <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                  Saving…
