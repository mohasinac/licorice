...
const variantClasses: Record<BadgeVariant, string> = {
  ...
  success: "bg-green-100 text-green-800 dark:bg-green-950/40 dark:text-green-400",
  warning: "bg-yellow-100 text-yellow-800 dark:bg-yellow-950/40 dark:text-yellow-400",
