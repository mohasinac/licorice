    ...
    <div className="flex flex-col gap-1">
      ...
      >
        <RadixSelect.Trigger
          ...
          aria-invalid={!!error}
          className={[
            "border-border text-foreground flex w-full items-center justify-between rounded-xl border bg-card px-4 py-2.5 text-sm shadow-sm",
            "focus:border-primary focus:ring-primary/20 transition-all duration-200 focus:ring-2 focus:outline-none",
