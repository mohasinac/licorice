...
export const SEED_CONSULTATION_CONFIG: ConsultationConfig & { id: string } = {
  ...
  consultantName: "Dr. Mariya Nallamandu",
  consultantTitle: "Certified Ayurvedic Practitioner",
  consultantBio:
    "<p>Dr. Mariya Nallamandu has over 10 years of experience in Ayurvedic skincare and hair care. She specialises in personalised wellness plans using traditional herbal formulations.</p>",
